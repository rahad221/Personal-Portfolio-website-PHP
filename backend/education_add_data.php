<?php
    ...
    if($flag){
        ...
        $course_insert_query = "INSERT INTO `course`(`course_name`, `course_Year`, `course_percent`, `course_status`) VALUES ('$course_name','$course_Year','$course_percent','$course_status')";
        $course_insert_query_db = mysqli_query($db_connect, $course_insert_query);
        $_SESSION['education_add'] = "Course Add Successfully";
        header('location: education_add.php');
    }
?>